...
import {
  ...
  type EmotionalArchaeologyInputV1,
  evolutionTrackerContractV1,
  type EvolutionTrackerInputV1,
  conversationMinerContractV1,
  type ConversationMinerInputV1,
  emotionalJourneyMapperContractV1,
  type EmotionalJourneyMapperInputV1
...
export async function registerAnalysisTools(server: McpServer) {
  ...
  server.registerTool(
    'emotional_archaeology',
    {
      ...
      inputSchema: emotionalArchaeologyContractV1.raw.input,
      outputSchema: emotionalArchaeologyContractV1.raw.output
    },
...
Focus on ${emotional_depth} level insights while respecting ${privacy_level} privacy.`;
  ...
  server.registerTool(
    'evolution_tracker',
    {
      ...
      inputSchema: evolutionTrackerContractV1.raw.input,
      outputSchema: evolutionTrackerContractV1.raw.output
    },
...
Provide insights at the ${pattern_depth} level focusing on ${analysis_focus}.`;
  ...
  server.registerTool(
    'conversation_miner',
    {
      ...
      inputSchema: conversationMinerContractV1.raw.input,
      outputSchema: conversationMinerContractV1.raw.output
    },
...
Focus on ${mining_focus} with ${extraction_depth} level analysis.`;
  ...
  server.registerTool(
    'emotional_journey_mapper',
    {
      ...
      inputSchema: emotionalJourneyMapperContractV1.raw.input,
      outputSchema: emotionalJourneyMapperContractV1.raw.output
    },
    async ({ song_structure, desired_journey, target_emotions, intensity_preference, resolution_style }: EmotionalJourneyMapperInputV1) => {
