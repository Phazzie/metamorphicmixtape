...
export async function registerAnalysisTools(server: McpServer) {
  ...
  const emotionalArchaeologyContract = analysisContracts.emotionalArchaeology;

  server.registerTool(
    emotionalArchaeologyContract.name,
    {
      title: emotionalArchaeologyContract.title,
      description: emotionalArchaeologyContract.description,
      inputSchema: emotionalArchaeologyInputSchema.shape,
      outputSchema: emotionalArchaeologyOutputSchema.shape
    },
