...
import {
  ...
  type ExtractSongDnaInputV1,
  constraintGeneratorContractV1,
  type ConstraintGeneratorInputV1,
  semanticBridgingContractV1,
  type SemanticBridgingInputV1,
  songEcosystemBuilderContractV1,
  type SongEcosystemBuilderInputV1
} from '@metamorphic/mixtape-contracts/meta';
...
export async function registerMetaTools(server: McpServer) {
  ...
  server.registerTool(
    'extract_song_dna',
    {
      ...
      inputSchema: extractSongDnaContractV1.raw.input,
      outputSchema: extractSongDnaContractV1.raw.output
    },
...
Provide deep insights that go beyond surface-level analysis.`;
  ...
  server.registerTool(
    'constraint_generator',
    {
      ...
      inputSchema: constraintGeneratorContractV1.raw.input,
      outputSchema: constraintGeneratorContractV1.raw.output
    },
...
Include examples of how these could lead to interesting results.`;
  ...
  server.registerTool(
    'semantic_bridging',
    {
      ...
      inputSchema: semanticBridgingContractV1.raw.input,
      outputSchema: semanticBridgingContractV1.raw.output
    },
...
Generate specific examples of how these bridges could work in lyrics.`;
  ...
  server.registerTool(
    'song_ecosystem_builder',
    {
      ...
      inputSchema: songEcosystemBuilderContractV1.raw.input,
      outputSchema: songEcosystemBuilderContractV1.raw.output
    },
    async ({ central_theme, ecosystem_size, connection_style, existing_songs, creative_ambition }: SongEcosystemBuilderInputV1) => {
