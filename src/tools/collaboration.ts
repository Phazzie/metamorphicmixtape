...
import {
  ...
  type AiChatSessionAnalyzerInputV1,
  chatExportHelperContractV1,
  type ChatExportHelperInputV1
} from '@metamorphic/mixtape-contracts/collaboration';
...
export async function registerCollaborationTools(server: McpServer) {
  ...
  server.registerTool(
    'ai_chat_session_analyzer',
    {
      ...
      inputSchema: aiChatSessionAnalyzerContractV1.raw.input,
      outputSchema: aiChatSessionAnalyzerContractV1.raw.output
    },
    async ({ chat_export, chat_format, analysis_focus, extract_versions, identify_consensus, track_evolution }: AiChatSessionAnalyzerInputV1) => {
...
Be thorough in extracting lyric versions even if they're embedded in discussion.`;
  ...
  server.registerTool(
    'chat_export_helper',
    {
      ...
      inputSchema: chatExportHelperContractV1.raw.input,
      outputSchema: chatExportHelperContractV1.raw.output
    },
