...
# APM 0.5.0 - Manager Agent Handover Prompt
...
1. **Read guides/Implementation_Plan_Guide.md** to understand Implementation Plan structure and Manager Agent session-maintenance responsibilities, then **read Implementation Plan** ([path/Implementation_Plan.md]) for current phase status and task assignments
2. **Read guides/Memory_System_Guide.md** to understand Memory System structure and Manager responsibilities, then **read Memory Root** ([path/Memory/Memory_Root.md]) for phase summaries and coordination history
3. **Read guides/Memory_Log_Guide.md** to understand Memory Log structure and review responsibilities, then **read recent Memory Logs** from current/latest phase ([path/Memory/current-phase-directory]) for latest agent outputs and dependencies
4. **Read guides/Task_Assignment_Guide.md** to understand Task Assignment structure and agent coordination responsibilities
