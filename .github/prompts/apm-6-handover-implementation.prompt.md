...
# APM 0.5.0 - Implementation Agent Handover Prompt
...
1. **Read guides/Memory_Log_Guide.md** to understand Memory Log structure and Implementation Agent logging responsibilities
