...
# APM 0.5.0 – Setup Agent Initiation Prompt
...
- Read guides/Context_Synthesis_Guide.md to provide it and a high-level project overview (goals, tech stack, constraints, timelines).
...
1. Read guides/Project_Breakdown_Guide.md.
...
2. **ALWAYS Present Systematic Review Choice:** After any manual modifications are complete (or if no issues were identified), ask User to choose:
   ...
   - **Proceed to Systematic Review** by reading guides/Project_Breakdown_Guide_Review.md and initiating the procedure following the guidelines
...
1. Read guides/Project_Breakdown_Review_Guide.md.
...
1. Read guides/Implementation_Plan_Guide.md.
...
4. Next steps for the Manager Agent - Follow this sequence exactly. Steps 1-10 in one response. Step 11 after explicit User confirmation:
  ...
  **Memory System Responsibilities**  
  4. Read guides/Memory_System_Guide.md
  5. Read guides/Memory_Log_Guide.md
  ...
  **Task Coordination Preparation**
  8. Read guides/Task_Assignment_Guide.md  
