...
# APM 0.5.0 – Implementation Agent Initiation Prompt
...
2. Read guides/Debug_Delegation_Guide.md
...
3. **Update Memory Log**: Complete designated log file per guides/Memory_Log_Guide.md
...
1. **Create Prompt:** Read and follow the appropriate delegation guide from `ad-hoc/` directory:
  - guides/Debug_Delegation_Guide.md for debugging issues
  - guides/Research_Delegation_Guide.md for information gathering
...
**Immediately read guides/Memory_Log_Guide.md.** Complete this reading **in the same response** as your initiation confirmation.
...
- **Follow Handover Prompt instructions** these include reading guides/Implementation_Agent_Handover_Guide.md, reviewing outgoing agents task execution history and processing their active memory context
