...
const aiChatSessionAnalyzerInputSchemaV1 = z.object({
  chat_export: z
    .string()
    .describe('Full chat transcript (copy-paste from ChatGPT/Claude/Gemini export or conversation)'),
  chat_format: z
...
const aiChatSessionAnalyzerOutputSchemaV1 = z.object({
...
export const aiChatSessionAnalyzerContractV1 = createToolContract(
  ...
  'v1',
  aiChatSessionAnalyzerInputSchemaV1,
  aiChatSessionAnalyzerOutputSchemaV1
);
...
const chatExportHelperInputSchemaV1 = z.object({
  platform: z
    .enum(['chatgpt', 'claude', 'gemini', 'all'])
    .default('all')
    .describe('Which platform you need export instructions for')
});

const chatExportHelperOutputSchemaV1 = z.object({
...
export const chatExportHelperContractV1 = createToolContract(
  'chat_export_helper',
  'v1',
  chatExportHelperInputSchemaV1,
  chatExportHelperOutputSchemaV1
);
...
export const collaborationContracts = {
  aiChatSessionAnalyzer: aiChatSessionAnalyzerContractV1,
  chatExportHelper: chatExportHelperContractV1
} as const;
