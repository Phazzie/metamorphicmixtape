...
const emotionalArchaeologyInputV1 = {
  data_sources: z
    .array(
...
const emotionalArchaeologyOutputV1 = {
...
const evolutionTrackerInputV1 = {
  ...
  analysis_focus: z
    .enum(['lyrical_development', 'structural_changes', 'thematic_evolution', 'technical_growth', 'emotional_maturity'])
...
const evolutionTrackerOutputV1 = {
  evolution_timeline: z
    .array(
      z.object({
        stage: z.string(),
...
const conversationMinerInputV1 = {
  conversation_text: z.string().describe('Text of conversation(s) to analyze'),
  mining_focus: z
    .enum(['emotional_moments', 'story_fragments', 'unique_phrases', 'relationship_dynamics', 'universal_themes'])
...
const conversationMinerOutputV1 = {
  song_seeds: z
    .array(
      z.object({
        concept: z.string(),
...
const emotionalJourneyMapperInputV1 = {
  song_structure: z
    .object({
...
const emotionalJourneyMapperOutputV1 = {
...
export const emotionalJourneyMapperContractV1 = createToolContract(
  ...
  emotionalJourneyMapperOutputV1
);
