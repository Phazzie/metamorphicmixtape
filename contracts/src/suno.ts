...
const generateSunoTagsInputV1 = {
  ...
  reference_artists: z
    .array(z.string())
    .optional()
    .describe('Optional: artists whose style to emulate (e.g., ["Bon Iver", "Sufjan Stevens"])'),
  specific_requests: z.string().optional().describe('Optional: specific musical elements wanted (e.g., "prominent piano")')
} satisfies z.ZodRawShape;

const generateSunoTagsOutputV1 = {
...
const optimizeSunoPromptInputV1 = {
...
const optimizeSunoPromptOutputV1 = {
...
const analyzeSunoOutputInputV1 = {
...
const analyzeSunoOutputOutputV1 = {
  analysis: z
    .object({
